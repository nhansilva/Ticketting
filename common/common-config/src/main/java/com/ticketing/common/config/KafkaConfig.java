 ...
 * Note: Spring Kafka doesn't have reactive support out of the box.
 * For reactive Kafka, consider using reactor-kafka directly or Spring Cloud Stream.
 */
@Configuration
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory() {
        ...
        factory.setConcurrency(3); // 3 concurrent consumers per partition
